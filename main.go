...
func init() {
	...
	if err != nil {
		log.Fatal("Cloud not read .env")
	}

	config.ClientID = os.Getenv("TWITTER_CLIENT_ID")
	config.ClientSecret = os.Getenv("TWITTER_CLIENT_SECRET")
}
...
func main() {
	...
	log.Println("Click the following link to login: http://127.0.0.1:8080/login")
